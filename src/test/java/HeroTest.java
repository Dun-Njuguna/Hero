...
public class HeroTest{
  ...
  public void getId_heroInstantiateWithAnID_1() {
    Hero myHero = new Hero("dun", 10 ,"nn", "nn");
  ...
  public void getSquad_initiallyReturnsEmptyList_ArrayList() {
    Hero myHero = new Hero("dun", 10 ,"nn", "nn");
    assertEquals(0, myHero.getSquad().size());
  }

  @Test
  public void addSquad_addsSquadToList_true() {
    Hero myHero = new Hero("dun", 10 ,"nn", "nn");
    Squad testSquad = new Squad("first",5,"fight");
    myHero.addSquad(testSquad);
    assertTrue(myHero.getSquad().contains(testSquad));
  }
